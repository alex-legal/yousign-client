...
export interface UserInput {
  ...
  notifications?: { procedure?: boolean };
}
...
export interface FileInput {
  ...
  metadata?: { key1?: string; key2?: number };
...
export interface SignatureUiInput {
  ...
  redirectCancel?: { url?: string; target?: "_top" | "_blank" | "_parent" | "_self"; auto?: boolean };

  /** Redirect when the Member gets an error on the procedure of the signature */
  redirectError?: { url: string; target?: "_top" | "_blank" | "_parent" | "_self"; auto?: boolean };

  /** Redirect when the Member has successfully signed the procedure */
  redirectSuccess?: { url?: string; target?: "_top" | "_blank" | "_parent" | "_self"; auto?: boolean };
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  authentications = {
     ...
     */
    inweboUpdate: (id: string, body: { signImage?: string }, params: RequestParams = {}) =>
      this.request<AuthenticationInweboOutput, any>({
        path: `/authentications/inwebo/${id}`,
        method: "PUT",
        body: body,
     ...
     */
    putAuthentications: (id: string, body: { code: string; signImage?: string }, params: RequestParams = {}) =>
      this.request<AuthenticationSmsOutput, { detail?: string }>({
        path: `/authentications/sms/${id}`,
        method: "PUT",
        body: body,
        format: "json",
     ...
     */
    emailUpdate: (id: string, body: { code: string; signImage?: string }, params: RequestParams = {}) =>
      this.request<AuthenticationEmailOutput, { detail?: string }>({
        path: `/authentications/email/${id}`,
        method: "PUT",
        body: body,
        format: "json",
  ...
  consentProcesses = {
     ...
     */
    consentProcessesList: (query?: { member?: string; procedure?: string }, params: RequestParams = {}) =>
     ...
     */
    consentProcessesDetail: (id: string, query?: { member?: string }, params: RequestParams = {}) =>
      this.request<ConsentProcessOutput, any>({
  ...
  consentProcessValues = {
     ...
     */
    consentProcessValuesDetail: (id: string, query?: { member?: string }, params: RequestParams = {}) =>
     ...
     */
    consentProcessValuesList: (query: { member: string }, params: RequestParams = {}) =>
      this.request<ConsentProcessValueOutput, any>({
  ...
  signatureUis = {
     ...
     */
    signatureUisDetail: (id: string, query?: { id?: string }, params: RequestParams = {}) =>
      this.request<SignatureUiOutput, any>({
     ...
     */
    signatureUisUpdate: (id: string, query?: { id?: string }, params: RequestParams = {}) =>
     ...
     */
    signatureUisDelete: (id: string, query?: { id?: string }, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/signature_uis/${id}`,
        method: "DELETE",
        query: query,
  ...
  signatureUiLabels = {
     ...
     */
    signatureUiLabelsList: (query?: { name?: string; signatureUi?: string }, params: RequestParams = {}) =>
     ...
     */
    signatureUiLabelsDetail: (id: string, query?: { id?: string }, params: RequestParams = {}) =>
      this.request<SignatureUiLabelOutput, any>({
     ...
     */
    signatureUiLabelsDelete: (id: string, query?: { id?: string }, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/signature_ui_labels/${id}`,
        method: "DELETE",
        query: query,
